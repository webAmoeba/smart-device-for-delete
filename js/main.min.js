...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_accordion__WEBPACK_IMPORTED_MODULE_3__["moveAccordion"])();
...
/*!*********************************!*\
  !*** ./js/modules/accordion.js ***!
  \*********************************/
/*! exports provided: moveAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveAccordion", function() { return moveAccordion; });
var buttons = document.querySelectorAll('.main-footer__accordion-toggler');
var accordions = document.querySelectorAll('.main-footer__accordion');
var headers = document.querySelectorAll('.main-footer__section-header');
if (accordions) {
  accordions.forEach(function (elem) {
    return elem.classList.add('main-footer__accordion--hidden');
  });
}
if (headers) {
  headers.forEach(function (elem) {
    return elem.classList.remove('main-footer__section-header--open');
  });
}
var moveAccordion = function moveAccordion() {
  if (buttons && accordions && headers) {
    buttons.forEach(function (button, index) {
      button.addEventListener('click', function () {
        if (accordions[index].classList.contains('main-footer__accordion--hidden')) {
          accordions.forEach(function (content, current) {
            if (index !== current) {
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open() {
      ...
      var focusedElement = modal.querySelector('[autofocus]');
      setTimeout(function () {
...
var button = document.querySelector('.about-company__button');
var descriptions = document.querySelectorAll('.about-company__grid p');
var mobileDescriptions = document.querySelectorAll('.about-company__mobile-description');
button.style.display = 'flex';
if (descriptions) {
  descriptions.forEach(function (elem, index) {
    return index > 1 ? elem.classList.add('about-company__description-hidden') : '';
  });
}
if (mobileDescriptions) {
  mobileDescriptions.forEach(function (elem) {
    return elem.classList.add('about-company__mobile-description--hidden');
  });
}
    ...
    if (button.classList.contains('about-company__button--rollup')) {
      ...
      if (descriptions) {
        descriptions.forEach(function (elem) {
          return elem.classList.remove('about-company__description-hidden');
        });
      }
      if (mobileDescriptions) {
        mobileDescriptions.forEach(function (elem) {
          return elem.classList.remove('about-company__mobile-description--hidden');
        });
      }
      if (button) {
